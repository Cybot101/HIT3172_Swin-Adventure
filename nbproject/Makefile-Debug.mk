...
${OBJECTDIR}/IdentifiableObject.o: IdentifiableObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/IdentifiableObject.o IdentifiableObject.cpp
...
${TESTDIR}/tests/IdentifiableObjectUnitTest.o: tests/IdentifiableObjectUnitTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/IdentifiableObjectUnitTest.o tests/IdentifiableObjectUnitTest.cpp
...
${TESTDIR}/tests/InventoryUnitTest.o: tests/InventoryUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/InventoryUnitTest.o tests/InventoryUnitTest.cpp


${TESTDIR}/tests/InventoryUnitTestRunner.o: tests/InventoryUnitTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/InventoryUnitTestRunner.o tests/InventoryUnitTestRunner.cpp


${TESTDIR}/tests/ItemUnitTest.o: tests/ItemUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/ItemUnitTest.o tests/ItemUnitTest.cpp
...
${TESTDIR}/tests/PlayerUnitTestRunner.o: tests/PlayerUnitTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/PlayerUnitTestRunner.o tests/PlayerUnitTestRunner.cpp
...
${OBJECTDIR}/GameObject_nomain.o: ${OBJECTDIR}/GameObject.o GameObject.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/GameObject_nomain.o GameObject.cpp;\
	else  \
...
${OBJECTDIR}/IdentifiableObject_nomain.o: ${OBJECTDIR}/IdentifiableObject.o IdentifiableObject.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/IdentifiableObject_nomain.o IdentifiableObject.cpp;\
	else  \
...
${OBJECTDIR}/Inventory_nomain.o: ${OBJECTDIR}/Inventory.o Inventory.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Inventory_nomain.o Inventory.cpp;\
	else  \
...
${OBJECTDIR}/Item_nomain.o: ${OBJECTDIR}/Item.o Item.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Item_nomain.o Item.cpp;\
	else  \
...
${OBJECTDIR}/Player_nomain.o: ${OBJECTDIR}/Player.o Player.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Player_nomain.o Player.cpp;\
	else  \
